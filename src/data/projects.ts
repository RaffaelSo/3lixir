...
const projectRecords: LocalizedProjectRecord[] = [
  {
    ...
    heroImage: asset("cyber-forest", "IMG_7090.JPG"),
    heroAlt: localized(
      "Cyber Forest hero image.",
      "Cyber-Forest-Hero-Bild.",
      "Hero-изображение проекта Cyber Forest.",
    ),
  ...
  },
  {
    ...
    heroImage: asset("cyber-wasteland", "791135892.443002public.JPEG"),
    heroAlt: localized(
      "Cyber Wasteland hero image.",
      "Cyber-Wasteland-Hero-Bild.",
      "Hero-изображение проекта Cyber Wasteland.",
    ),
  ...
  },
  {
    ...
    heroAlt: localized(
      ...
      "Hero-изображение проекта Arctica 3D.",
    ),
